...
$sql = mysqli_query($MySQLiconn,"SELECT * FROM `akun` WHERE username = '$_POST[username]' ") or die(mysql_error());
if(mysqli_num_rows($sql) == 0)
{
	...
	(mysqli_query($MySQLiconn,$input_akun));
	(mysqli_query($MySQLiconn,$input_murid));
}	
else
{
	echo (" <SCRIPT LANGUAGE='JavaScript'>

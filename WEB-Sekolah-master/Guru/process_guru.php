...
$hasil_murid=mysqli_query($MySQLiconn,$tampil_murid);
$N = 1;
$T = 10000;
$A = 20000;
...
while ($data_murid=mysqli_fetch_array($hasil_murid))
{
	...
	$tampil_nilai=mysqli_query($MySQLiconn,"SELECT * FROM `nilai` WHERE nama_murid = '$nama_murid' and jurusan = '$jurusan' and kelas = '$kelas' and nama_matapelajaran = '$nama_mpl'");
	...
	if(mysqli_num_rows($tampil_nilai) == 0)
	{
		...
		(mysqli_query($MySQLiconn,$sqlstr));
	}
	else
	{
